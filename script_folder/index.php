        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            <div style="margin: 20px;">
                ...
                <p style="font-size: 14px;">
                    Se informa que se registró un nuevo análisis de arribo empresa_frutas. 
...
function consultaBDReferenciaSync($conn) {
    $sql = 'SELECT ope.referencia_op AS referencia,
            ...
            LEFT JOIN tbl_sync_empresa_frutas sync ON sync.numeroContainer = ot1.numeroContainer
...
function verificarNumeroContainer($conn, $numeroContainer, $tipoReporte){
    $check_sql = "SELECT urlDocumento FROM tbl_sync_empresa_frutas WHERE numeroContainer = ? AND tipoReporte = ?";
    $stmt = $conn->prepare($check_sql);
